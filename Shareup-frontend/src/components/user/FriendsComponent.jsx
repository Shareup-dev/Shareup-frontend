        ...
        <div className='tab-pane active fade show ' id='frends'>
          <div style={{ contentAlign: 'center', textAlign: 'center', paddingTop: '15px' }}>
            {friendsList.length > 0 ? (
              <p style={{ marginBottom: '5px', fontWeight: 'medium', fontSize: '24px', color: '#646464' }}>
                Your Friends!
              </p>
            ) : (
                    ...
                    {user.id !== userM.id ? (
                      !friendsList.some((el) => el.id === userM.id) ? (
                        ...
                        <>
                          <a
                            href='#'
                            style={{ color: '#fff', background: '#033347' }}
                            className='button more-action'
                            data-ripple
                      ...
                      <div class='item5'>{/* <p style={{ float: "right" }}>Your own profile</p> */}</div>
                    )}
                  </div>
                  <div class='item4'></div>
                  {/* <div class="item6">
            ...
            {following.map((userM) => (
              <li key={userM.id} className='friends-card grp'>
                <div className='grid-container'>
                  ...
                  <div class='item1'>
                    <a href={`/profile/${userM.email}`} title={`${userM.email}`}>
                      <img src={fileStorage.baseUrl + userM.profilePicturePath} alt='' />
                    </a>
                    {/* </figure> */}
                  </div>
                  {/* <div className="  "> */}
                  <div class='item2'>
                    ...
                    <a href='#' className='add-butn more-action' data-ripple onClick={() => handleUnfollow(userM.id)}>
                      unfollow
                    </a>
                  </div>
          ...
          <div className='frnds'>
            ...
            <div class='navContent'>
              <ul class='nav nav-pills' role='tablist'>
                <li class='nav-item'>
                  <a class='nav-link active' data-toggle='pill' href='#!' onClick={() => setShowComp('members')}>
                    {' '}
                    <i class='las la-user'></i>Friends <a className='numberCircle'>{`${allUser.length}`}</a>
                  </a>
                ...
                <li class='nav-item'>
                  <a class='nav-link active' data-toggle='pill' onClick={() => setShowComp('followers')}>
                    {' '}
                    <i class='las la-user-tag'></i> Followers <a className='numberCircle'>{`${followers.length}`}</a>
                  </a>
