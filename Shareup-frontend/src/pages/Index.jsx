      ...
      return (
        <div className="log-reg-area reg">
          ...
          <form>
            ...
            {registerError && <p style={{ fontSize: 15, color: 'red', textAlign: 'center' }}>{registerError}</p>}
            <div className="row">
            ...
            {emailError && <p style={{ fontSize: 15, color: 'red', textAlign: 'center' }}>{emailError}</p>}
            <div className="row">
              <div className="form-group">
                <input
            ...
            <a href="#" onClick={() => setShowComponent('login')} className="already-have">
    ...
    if (showComponent === 'login') {
      return (
        <div className="log-reg-area">
          ...
          <p>
            {loginError && <div style={{ fontSize: 20, color: 'red', textAlign: 'center' }}>{loginError}</div>}
            {allFieldFillError && (
              <p style={{ fontSize: 15, color: 'red', textAlign: 'center' }}>{allFieldFillError}</p>
            )}
          </p>
          ...
          <form>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <a href="#" onClick={() => setShowComponent('register')} className="already-have">
