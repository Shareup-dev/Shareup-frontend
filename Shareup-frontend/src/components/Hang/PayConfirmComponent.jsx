          ...
          <div className='central-meta hanggift'>
            <div className='containerHang'>
              <div className='center'>
                <div>
                  <img width='170' src='assets/images/success.png' />
                </div>
                <h1 style={{ fontWeight: 'bold', marginTop: '20px' }}>Congratulations</h1>
                <p style={{ fontSize: '14px', margin: '20px 0 40px 0', lineHeight: '2' }}>
                  Payment is the transfer of money <br />
                  services in exchange product or Payments{' '}
                </p>
                <div style={{ margin: '0 0 40px 0' }}>
                  <a className='Hangin-btn' href='/share' onclick={() => setGift('Gift')}>
                    Keep Hang
                  </a>
                </div>
              </div>
