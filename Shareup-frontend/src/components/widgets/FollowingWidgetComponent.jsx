...
function FollowingWidgetComponent() {
  ...
  return (
    <div className='widget'>
      <div className='row'>
        <img src='../assets/images/Public-Account-300x300.png' />
        <p className='widget-title'>Who's following</p>
      </div>
        ...
        {followers.slice(0, 5).map((follower_user) => (
          <li key={follower_user.id}>
            ...
            <div className='friend-meta'>
              <h4>
                <a
                  href={`/profile/${follower_user.email}`}
                  title=''
                >{`${follower_user.firstName} ${follower_user.lastName}`}</a>
              </h4>
