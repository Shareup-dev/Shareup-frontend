                    ...
                    <div className='row' id='page-contents'>
                        ...
                        <aside className='sidebar static'>
                          <div className='widget'>
                            ...
                            <div className='user'>
                              ...
                              <a href='/profile'>
                                <p style={{ fontWeight: 'bold' }}>{`${props.user.firstName} ${props.user.lastName}`}</p>
                              </a>
                            </div>
                          </div>
                              ...
                              <ul className='naves'>
                                ...
                                <li>
                                  <div style={{ marginRight: '10px', display: 'inline' }}>
                                    <i className='ti-user' />
                                    <p
                                      style={{ fontSize: '18px', color: 'blue', marginLeft: '-8px', display: 'inline' }}
                                    >
                                      +
                                    </p>
                                  </div>
                                ...
                                <li>
                                  <div style={{ marginRight: '2px', display: 'inline' }}>
                                    <i className='ti-user' />
                                    <i className='ti-user' style={{ marginLeft: '-19px' }} />
                                  </div>
                                  <a href='/groups' title='#'>
                                    ShareGroups
                                  </a>
                      ...
                      <div className='col-lg-3'>
                        <aside className='sidebar static'>
                          ...
                          <div className='widget friend-list stick-widget'>
                            <div className='row'>
                              <img src='../assets/images/Trends1.jpg' />
                              <p className='widget-title'>News</p>
                            </div>
                            <div className='news'>
                              <a href='#' data-lightbox='image-1' data-title='My caption'>
                                <img src='../assets/images/Trends1.jpg' style={{ height: '100px' }}></img>
                              </a>
                            </div>
                          </div>
