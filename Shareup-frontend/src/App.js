...
import { testScript } from "./utils/js/script.js";
    ...
    <UserContext.Provider value={{ user }}>
      ...
      <Router>
        ...
        <Switch>
          ...
          <ProtectedRoute
            path="/shareFeed"
            component={ShareFeedComponent}
          ></ProtectedRoute>
          <ProtectedRoute
            path="/notifications"
            component={NotificationChatComponent}
          ></ProtectedRoute>
          <ProtectedRoute
            path="/new-user"
          ...
          <ProtectedRoute
            path="/group/create"
            component={CreateGroupComponentMain}
          ></ProtectedRoute>
          ...
          <ProtectedRoute
            path="/swapFeed"
            component={SwapFeedComponent}
          ></ProtectedRoute>
          <ProtectedRoute
            path="/savedShares"
            component={SavedSharesComponent}
          ></ProtectedRoute>
          <ProtectedRoute
            path="/swappost"
            component={SwapPostComponent}
          ></ProtectedRoute>
          <ProtectedRoute
