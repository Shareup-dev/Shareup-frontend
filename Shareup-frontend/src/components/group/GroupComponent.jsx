...
function GroupComponent({ post }) {
  ...
  const getMyGroups = async () => {
    await GroupService.getGroupByCurrentUser(user.email).then((res) => {
      const uniqueGroups = Array.from(new Set(res.data.map((a) => a.id))).map((id) => {
          ...
          <div className='frnds'>
            ...
            <div class='navContent'>
              <ul class='nav nav-pills' role='tablist'>
                <li class='nav-item'>
                  <a class='nav-link active' data-toggle='pill' href='#!' onClick={() => setShowComp('allgroups')}>
                    {' '}
                    <i class='las la-users'></i> All Groups <a className='numberCircle'></a>
                  </a>
                  {/* <span>{`${allUser.length}`}</span> */}
                </li>
                <li class='nav-item'>
                  <a class='nav-link active' data-toggle='pill' onClick={() => setShowComp('mygroups')}>
                    {' '}
                    <i class='las la-user-friends'></i> My Groups <a className='numberCircle'></a>
                  </a>
                  {/* <span>{`${following.length}`}</span> */}
                </li>
                <li class='nav-item'>
                  <a class='nav-link active' data-toggle='pill' href='/group/create'>
                    {' '}
                    <i class='las la-plus-circle'></i> Create Group <a className='numberCircle'></a>
                  </a>
