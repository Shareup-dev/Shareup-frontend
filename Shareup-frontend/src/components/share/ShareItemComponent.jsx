  ...
  return (
    <Layout user={user ? user : userR}>
      <div className='col-lg-6'>
        ...
        {/* add post new box */}
        <p className='showCompNewsfeed' style={{ fontWeight: 'bold', color: 'rgb(207, 144, 7)', textAlign: 'center' }}>
          <span onClick={() => setShowComp('newsfeed')}>SharePosts</span> |{' '}
          <span onClick={() => setShowComp('saved')}>Saved Posts</span>
        </p>
        <div className='central-meta item'>
          <div className='user-post'>
              ...
              <div className='post-meta'>
                ...
                <div className='friend-name'>
                  <div style={{ float: 'left', display: 'inline' }}>
                    <a href='#' title='#' style={{ textTransform: 'capitalize', fontWeight: 'bold' }}>
                ...
                <div className='buttonS'>
                  <a href='/shipping' className='buttonshare'>
                    Accept
                  </a>
                </div>
                    ...
                    <div className='commShare'>
                      ...
                      <div className='btncmn'>
                        <span className='views' data-toggle='tooltip'>
                          ...
                          <span style={{ paddingLeft: '2px' }}>Share</span>
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <li className='post-comment'>
                  ...
                  <div className='post-comt-box'>
                    <Form>
                      ...
                      <div className='gif'>
                        <img style={{ objectFit: 'cover' }} src='/assets/images/sticker.png' alt='' />
                      </div>
                      <div className='cam'>
            ...
            {showMoreOptions && (
              <div className='drop-options active'>
                <ul>
