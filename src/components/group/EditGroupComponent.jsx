...
function EditGroupComponent(props) {
    ...
    const handleEditGroup = async (num) => {
        let groupData = {
            name: groupName,
        ...
        // let groupId 
        await GroupService.editGroup(groupid, groupData).then(res => {            
            setStep(num)
        })
        
        setTimeout(function () { history.push(`/groups/${groupid}`) }, 2000);
    }
        ...
        if (step === 0) {
            return (
                <fieldset>
                    ...
                    <input type="button" name="" className="action-button" defaultValue="Edit" onClick={() => validateStep(2)} />
                </fieldset>
            )
        }
                    ...
                    <div className="form-card">
                        ...
                        <div className="row justify-content-center">
                            <div className="col-7 text-center">
                                <h5>You Have Successfully Edited Group</h5>
            ...
            <div className="col-lg-6">
                <div className="central-meta create-group">
                    <div className="card px-0 pt-4 pb-0 mb-3">
                        ...
                        <h2 style={{fontSize:'20px' , fontWeight:'800'}} className="media-date">Edit Your Group</h2>
                        {/* <p>Fill all form field to go to next step</p> */}
                        </div>
                        <div className="row">
                            <div className="col-md-12 mx-0">
