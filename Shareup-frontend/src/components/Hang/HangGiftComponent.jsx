            ...
            <div className='row'>
              <div style={{ display: 'inline', width: '33%' }}>
                <img
                  ...
                  src='assets/images/virtual-baby-showers-722x406.jpg'
                />{' '}
              </div>
              ...
              <div style={{ display: 'inline', width: '33%', float: 'right', padding: '0 10px' }}>
                {' '}
                <div
                  style={{
                    float: 'right',
                    marginTop: '30px',
                    padding: '5px 10px',
                    background: 'rgb(3, 51, 71)',
                    color: '#fff',
                    borderRadius: '5px',
                  }}
                >
                  <a style={{ color: '#fff', padding: '5px', fontSize: '12px' }} href='/checkout'>
                    +
                  </a>
                </div>
              </div>
          ...
          <div className='containerBrand'>
            ...
            <div className='row'>
              <div className='brandlogo'>
                <img src='assets/images/bestbuy.jpg' />{' '}
              </div>
              ...
              <div className='arrow'>
                <a href='#' onClick={() => setShowBrands('Gifts')}>
      ...
      return (
        <div className='loadMore'>
          <div className='containerBrand'>
            <div className='row'>
              <div className='brandlogo'>
                <img src='assets/images/Talabatlogo.png' />{' '}
              </div>
              <div className='branddesrptn'>
                <div style={{ padding: '0px 0 5px 5px', fontSize: '14px', fontWeight: 'bold' }}>Best Buy</div>
                <div style={{ padding: '0px 0 5px 5px', fontSize: '14px' }}>All popular items</div>
              ...
              <div className='arrow'>
                <a href='#' onClick={() => setShowBrands('Meals')}>
                  <i class='las la-angle-down'></i>
                </a>
              </div>
            </div>
        ...
        <div className='loadMore'>
          <div className='containerBrand'>
            <div className='row'>
              ...
              <div className='arrow'>
                <a href='#' onClick={() => setShowBrands('Outfits')}>
                  <i class='las la-angle-down'></i>
                </a>
              </div>
            </div>
      ...
      <Layout user={user}>
        <div className='col-lg-6'>
          <div className='central-meta hanggift'>
            <h1 style={{ textAlign: 'center', padding: '10px', fontSize: '18px', fontWeight: 'bold' }}>
              Today to me, tomorrow to you
            </h1>
            <div className='containerHang'>
              {' '}
              <div className='row rowalin'>
                <div className='col-lg-3 padg'>
                  <div className='flow'>
                    {' '}
                    <a
                      className={showHang === 'hangGifts' ? 'active' : ''}
                      title=''
                      data-ripple=''
                      onClick={() => setShowHang('hangGifts')}
                    >
                      <i class='las la-gift' style={{ fontSize: '32px' }}></i>
                      <div>Hang Gifts</div>
                    </a>
                  </div>
                </div>
                <div className='col-lg-3 padg'>
                  ...
                  <div className='flow'>
                    <a
                      className={showHang === 'hangMeals' ? 'active' : ''}
                      title=''
                      data-ripple=''
                      onClick={() => setShowHang('hangMeals')}
                    >
                      <i class='las la-utensils' style={{ fontSize: '32px' }}></i>
                      <div>Hang Meals</div>
                    </a>
                  </div>
                </div>
                <div className='col-lg-3 padg'>
                  ...
                  <div className='flow'>
                    <a
                      className={showHang === 'hangOutfits' ? 'active' : ''}
                      title=''
                      data-ripple=''
                      onClick={() => setShowHang('hangOutfits')}
                    >
                      <i class='las la-gift' style={{ fontSize: '32px' }}></i>
                      <div>Hang Outfits</div>
                    </a>
                  </div>
                </div>
                <div className='col-lg-3 padg'>
                  ...
                  <div className='flow'>
                    <a
                      className={showHang === 'hangAccessories' ? 'active' : ''}
                      title=''
                      data-ripple=''
                      onClick={() => setShowHang('hangAccessories')}
                    >
                      <i class='las la-gift' style={{ fontSize: '32px' }}></i>
                      <div>Hang Accessories</div>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className='contentArea'>{handleshowH()}</div>
          </div>
        </div>
      </Layout>
    </>
