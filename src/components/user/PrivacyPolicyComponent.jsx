      ...
      <div className="theme-layout">
        <div className="container-land pdng0 text-center">
          <div className="topbarLand transparent text-center">
            <div className="row">
              <div className="logo  text-center col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                <a href="/">
                  <img
          ...
          <div className="row mt-5 ">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-5 ">
              <div className="container">
                <div className="about-story mt-5">
                  <h2 className="heading">SHAREUP's Privacy Bill of Rights</h2>
                  <p
                    style={{
                  ...
                  >
                    ...
                    <br />
                    <br />
                    We take your privacy very seriously. We seek to explain to
                    ...
                    carefully, as it is important. If there are any terms in
                    this privacy policy that you do not agree with, please
                    discontinue use of our sites and our services. This privacy
                    ...
                    >
                      ...
                      or our products and services, when participating in
                      activities on the Services or otherwise contacting us. The
                  ...
                  >
                    ...
                    the activity on our Services and hold certain information.
                  ...
                  >
                    ...
                    guide their online activity. Our Service does not address
                    anyone under the age of 16 ("Children").
                    <br />
                    <br />
                  ...
                  >
                    ...
                    <br />
                    <br />
                    Blockchain Technology legal basis for collecting and using
                    ...
                    <ul className="unorderedlist">
                      <li>
                        Blockchain Technology needs to perform a contract with
                        you
                      </li>
                      <li>
                        You have given Blockchain Technology permission to do so
                      </li>
                      <li>
                        Processing your personal information is in Blockchain
                        Technology legitimate interests
                      </li>
                      <li>
                        Blockchain Technology needs to comply with the law
                      </li>
                    ...
                    <br />
                    <br />
                    Blockchain Technology will retain your personal information
                    ...
                    you have certain data protection rights and the operator
                  ...
                  >
                    ...
                    <ul className="unorderedlist">
                      ...
                      <li>
                        You have the right to access, update or to delete the
                        information we have on you.
                      </li>
                      <li>
                        You have the right to the right to withdraw consent,
                        object data portability and rectification.
                      </li>
                      <li>
                        You have the right to request that we correct any
                        personal information you believe is inaccurate.
                      </li>
                      <li>
                        You also have the right to request us to complete the
                      ...
                      <li>
                        When you restrict the processing of your personal
                      ...
                      <li>
                        ...
                        time where the operator relied on your consent to
                  ...
                  >
                    ...
                    <ol className="orderedlist">
                      ...
                      country, location, information about who and when you use
                      our and other technical information. This information is
                      ...
                      residence and actual address and telephone number (work,
                      mobile).
                      <br />
                      <br />
                      Whilst one of these signs on its own might not give cause
                      for concern, two or more may give rise to a potential red
                      flag. Use common sense and report any suspicious signs to
                      the local authorities if you suspect sex/human
                      trafficking.
                      <br />
                      <br />
                      <b
                      ...
                      Please report any suspected sexual exploitation of minors
                  ...
                  >
                    ...
                    >
                      {" "}
                      Data Protection Rights under the California Privacy
                    ...
                    <ul className="unorderedlist">
                      ...
                      <li>
                        Users can request to change their personal information
                        by emailing us at info@shareup.qa.
                      </li>
                    </ul>
                    <br />
                    <br />
                  ...
                  >
                    ...
                    rights, you can make certain requests and ask us anytime.
                  </p>
                  ...
                  >
                    ...
                    <br />
                    <br />
                    The Qatari Law No. 13 of 2016 ("the Personal Data Privacy
                    Protection Law") took effect in 2017, with the aim of
                    protecting and providing guidelines of processing personal
                    data within Qatar. In December 2020, the Compliance and Data
                    Protection Department (CDP) within the Ministry of Transport
                    and Communications (MOTC) published new guidelines in
                    relation to the Law. The scope of the PDPPL applies to
                    personal data that is received, collected, extracted, or
                    processed through electronic or traditional methods.
                    <br />
                    <br />
                    Any organization that processes such personal data must
                    adhere to the principles of transparency, fairness, and
                    respect for human dignity. The law has a large focus on
                    organizations ensuring that the personal data they process
                    is up to date and there are adequate measures in place for
                  ...
                  >
                    ...
                    <br />
                    <br />
                    Each Individual has the right to the protection of the
                    Personal Data there of that shall be processed only within
                    the framework of transparency, honesty, and respect of human
                    dignity, and acceptable practices according to provisions.
                    The Controller shall process Personal Data only after
                    obtaining the consent of the Individual unless data
                    processing is necessary to achieve a Lawful Purpose for the
                    Controller or the other recipient of such data. An
                    Individual may at any time:
                    <br />
                    <br />
                    <ul className="unorderedlist">
                      <li>
                        Withdraw the prior consent thereof for Personal Data
                        Processing.{" "}
                      </li>
                      <li>
                        Object to processing the Personal Data thereof if such
                        processing is not necessary to achieve the purposes for
                        which such Personal Data have been collected or where
                        such collected Personal Data are beyond the extent
                        required, discriminatory, unfair or illegal.{" "}
                      </li>
                      <li>
                        Request omission or erasure of the Personal Data thereof
                        in any of the cases referred to in the preceding two
                        items , upon cessation of the purpose for which the
                        processing has been conducted, or where all
                        justifications for maintaining such Personal Data by the
                        Controller cease to exist.{" "}
                      </li>
                      <li>
                        Request corrections to the Personal Data thereof. A
                        request so made shall be accompanied with proof of the
                        accuracy of such request.
                      </li>
                    </ul>
                    <br />
                    <br />
                    An Individual may, at any time, access the Personal Data
                    thereof and apply to review the same, in facing any
                    Controller, and an Individual has, in particular, the right
                    to:
                    <br />
                    <br />
                    <ul className="unorderedlist">
                      <li>
                        Be notified of processing the Personal Data thereof and
                        the purposes for which such processing is conducted.{" "}
                      </li>
                      <li>
                        Be notified of any disclosure of inaccurate personal
                        data
                      </li>
                    </ul>
                  </p>
                  ...
                  >
                    ...
                    <br />
                    <br />
                    If your organization fails to protect personal data and
                    comply with Law No. 13 then you are exposed to not only high
                    financial penalties (ranging from QAR 1,000,000 to QAR
                    5,000,000 in fines) but operational inefficiencies,
                    intervention by regulators, and most importantly permanent
                    loss of your consumer trust.
                  </p>
                  ...
                  >
                    ...
                    <br />
                    <br />
                    On 1 August 2019, Bahrain Law No. 30 of 2018 promulgating
                    the Personal Data Protection Law (PDPL) came into force in
                    the Kingdom. Modelled on European Union data protection
                    laws, the PDPL is the second national law in the Gulf region
                    to directly address the right to personal data protection
                    and will impose obligations on businesses that collect
                    personal data in relation to how organizations use and
                    secure it.
                    <br />
                    <br />
                    <i style={{ fontStyle: "italic" }}>
                      ...
                      >
                        {" "}
                        prison sentences of up to 1 year.
                      </b>
                    </i>
                    <br />
                    <br />
                    The law includes additional requirements for organizations
                    to submit their data processing registers monthly to the
                    Authority and has shorter timelines for compliance with
                    individuals' rights.
                  </p>
                  ...
                  >
                    ...
                    <br />
                    <br />
                    Egypt published a Personal Data Protection Law in July 2020
                    that addresses the right to personal data protection and
                    gives multiple rights to individuals. According to the Law,
                    personal data should only be collected for specific
                    legitimate purposes and should not be retained longer than
                    necessary. Organizations may need to acquire a license to
                    process both personal and sensitive personal data.
                    Additionally, organizations involved in the processing of
                    personal information are expected to appoint an authorized
                    Data Protection Officer (DPO) who will be responsible for
                    the application of this law within the organization. The
                    Personal Data Protection Law has provisions for
                  ...
                  >
                    ...
                    <br />
                    <br />
                    The DIFC Data Protection Law (DIFC Law No. 5 of 2020) has
                    been effective since 1 July 2020 and enforceable as of 1
                    October 2020. The DIFC law aims to safeguard the personal
                    data of individuals whose data is processed by DIFC
                    registered entities. It is heavily influenced by the EU
                    General Data Protection Regulation (GDPR) as well as other
                    world-class data protection laws.
                    <br />
                    <br />
                    Some of the key features of the new law include the
                    clarification of data subjects’ rights, the facilitation of
                    appropriate data sharing structures between governmental
                    authorities, as well as the introduction of a framework that
                    will support the DIFC’s bid for adequacy recognition by the
                    European Commission and the UK, which will enable data
                    transfers from the DIFC to the EU and the UK. Organizations
                  ...
                  >
                    ...
                    <ol className="orderedlist-faq">
                      <li>
                        <i style={{ fontStyle: "italic" }}>What is Shareup?</i>
                      </li>
                      Shareup is a social media platform that is integrated with
                      blockchain technology. It enables the users to share and
                      ...
                      decentralized, distributed ledger that records the
                      provenance of a digital asset. By inherent design, the
                      data on a blockchain is unable to be modified, which makes
                      it a legitimate disruptor for industries like payments and
                      cybersecurity.
                      <a
                      ...
                      >
                        (courtesy: https://builtin.com/blockchain)
                      </a>
                      <br />
                      <br />
                      <li>
                        <i style={{ fontStyle: "italic" }}>
                          Which devices is Shareup available on?
                        </i>
                      </li>
                      Shareup is available on Android or iOS smartphone, as well
                      as on all desktops and tablets.
                      <br />
                      <br />
                      <li>
                        <i style={{ fontStyle: "italic" }}>
                          What content can I share on Shareup?
                        </i>
                      </li>
                      At Shareup, you can safely share photos, videos,
                      documents, voice messages, chats, gifts, memes, doodles,
                      and more. You can communicate 1-to-1 and in private groups
                      with your contacts, friends, family, co-workers, and in
                      open groups with other Shareup members with whom you share
                      a common interest or hobby.
                      <br />
                      <br />
                      <li>
                        <i style={{ fontStyle: "italic" }}>
                          What are some unique features of Shareup?
                        </i>
                      </li>
                      Shareup is an advanced social network with features that
                      give you total control, including:
                      <ul className="unorderedlist">
                        <li>
                          Hangshare – Not only do you share images and videos
                          but if you have more than you need then Shareup
                          enables you share or support other people.
                        </li>
                        <li>
                          Swap – If you want to swap anything with friends or
                          public, Shareup is the safe platform to do so. Real
                          people real accounts{" "}
                        </li>
                        <li>
                          KYC (Knowing Your Customer) – All the Shareup accounts
                          are verified and are registered with real identities.
                        </li>
                        <li>
                          Universal tagging - This is a new, convenient way to
                          sort and organize all the content you receive and
                          share, making it easy to find everything, anytime.
                        </li>
                        <li>
                          Enhanced permission control (patent issued) - Manage
                          permissions on a granular level and decide exactly who
                          sees what. You can also remove yourself from the
                          search directory, make yourself invisible to other
                          members online, and much more.
                        </li>
                      </ul>
                      <br />
                      <br />
                      ...
                      You control who receives and views your posts. Since there
                      is no way to boost anything on Shareup, you can be assured
                      that your posts are shared only with members you connect
                      with. Shareup does not spy on your private posts.
                      <br />
                      <br />
                      <li>
                        <i style={{ fontStyle: "italic" }}>
                          Can I delete my Shareup account and is it easy to do
                          this?
                        </i>
                      </li>
                      Yes! We make it easy to delete all your Shareup content
                      anytime, and to delete your account. To delete, first
                      delete any groups you own or transfer ownership to another
                      user. Once you are no longer an owner of any groups, you
                      can quickly delete your account with the following steps:
                      <br />
                      <br />
                      <ol className="unorderedlist">
                        <li>
                          {" "}
                          Click on My Account in the upper right area of your
                          screen.
                        </li>
                        <li>
                          Scroll down to Delete My Account at the bottom left
                          area of the window prompt.
                        </li>
                      </ol>
                      <br />
                      <br />
                      ...
                      law that was implemented May 25, 2018 and requires
                      organizations to safeguard personal data and uphold the
                      privacy rights of anyone in EU territory. The regulation
                      includes seven principles of data protection that must be
                      implemented and eight privacy rights that must be
                      facilitated
                    </ol>
                  </p>
                </div>
