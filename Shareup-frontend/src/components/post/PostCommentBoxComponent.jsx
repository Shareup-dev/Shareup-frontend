                ...
                <div className="post-comt-box">
                  <Form>
                    ...
                    <div className="btncmnt">
                       ...
                       <button type="button" onClick={() => handlePostingComment(post.id)} style={{ color: 'blue', padding: '5px' }}>
                      <div style={{width:"20px",height:"25px"}}> <img  src="/assets/images/submit4.png" alt="" style={{width:"100%",height:"100%",padding:"2px",borderStyle:"2px solid black"}} /> </div>
