    ...
    if (showField === 'logininfo') {
      return (
        <>
          <li className='bckgrnd'>
            {' '}
            <div className='buttnScrty'>
              <button className='buttonLoginInfo active'>Save Your Login Info</button>
            </div>
          </li>
          <li className='bckgrnd'>
            <div className='buttnScrty'>
              {' '}
              <button className='buttonLoginInfo'>Remove Account</button>
            </div>
          </li>
        </>
      );
    ...
    if (showField === 'frndSrch') {
      return (
        <>
          <li className='bckgrnd'>
            {' '}
            <div className='buttnScrty'>Choose the friend you trust to help you when you have trouble in logging</div>
          </li>
          <li className='bckgrnd'>
            {' '}
            <div className='buttnScrty'>
              <div class='friends-search-container-Scrty'>
            ...
            <div className='right-settings-bio'>
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      <p className='secrtySec'>name</p>{' '}
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('editname')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('editname')}>
                          Edit
                        </p>
                      )}
                    </li>
            ...
            <div className='right-settings-bio'>
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      <p className='secrtySec'>
                        https://shareup.qa/name
                        <br />
                      </p>{' '}
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('username')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('username')}>
                          Edit
                        </p>
                      )}
                    </li>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      ...
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('phno')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('phno')}>
                          Edit
                        </p>
                      )}
                    </li>
                  ...
                  <ul>
                    <li className='firstElement'>
                      <p className='secrtySec'>
                        Change Password
                        <br />
                        <span className='scnd'>Use Strong Password</span>
                      </p>{' '}
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('frgtpswd')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('frgtpswd')}>
                          Edit
                        </p>
                      )}
                    </li>
                    ...
                    <li>
                      <p className='secrtySec'>
                        ...
                        <br />
                        <span className='scnd'>It will only be saved on the browsers and devices you choose</span>
                      </p>{' '}
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('logininfo')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('logininfo')}>
                          Edit
                        </p>
                      )}
                    </li>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      ...
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('notif')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('notif')}>
                          Edit
                        </p>
                      )}
                    </li>
                    ...
                    <li>
                      <p className='secrtySec'>
                        ...
                        <br />
                        <span className='scnd'>
                          Your trusted contacts can send a code and URL from ShareUp to help you log back in
                        </span>
                      </p>
                      {showField === 'editname' ? (
                        <p className='secrtyEdt active' onClick={() => setshowField('frndSrch')}>
                          Edit
                        </p>
                      ) : (
                        <p className='secrtyEdt' onClick={() => setshowField('frndSrch')}>
                          Edit
                        </p>
                      )}
                    </li>
            ...
            <div className='right-settings-bio firstElement'>
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      <p className='secrtySec'>Turn on Location for your mobile devices?</p>
                      <DropdownOnComponent />
                    </li>
                  </ul>
                </div>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      <p className='secrtySec'>
                        Language for buttons, titles and other text from Shareup for this account.
                      </p>
                      <p className='secrtyEdt'>English(UK)</p>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      <p className='secrtySec'>
                        Language into which you’d like to have posts translated
                        <br />
                      </p>
                      <p className='secrtyEdt'>English</p>
                    </li>
                    <li className='firstElement'>
                      <p className='secrtySec'>
                      ...
                      <p className='secrtyEdt'>English, Indonesian, Arabic</p>
                    </li>
                    <li>
                      <p className='secrtySec'>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li>
                      <p className='secrtySec'>
                        A feature that lets you post multiple language versions of a status.
                        <br />
                      </p>
                      <DropdownOnComponent />
                    </li>
            ...
            <div className='right-settings-bio'>
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      <p className='secrtySec'>Who can post on your profile?</p>
                      <DropdownComponent />
                    </li>
                    <li className='firstElement'>
                      <p className='secrtySec'>Who can see what others post on your profile?</p>
                      <DropdownComponent />
                    </li>
                    <li className='firstElement'>
                      <p className='secrtySec'>Allow others to share your posts to their story?</p>
                      <DropdownOnComponent />
                    </li>
                    <li>
                      <p className='secrtySec'>Who can see what others post on your profile?</p>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    ...
                    <li>
                      <p className='secrtySec'>
                        When you're tagged in a post, who do you want to add to the audience of the post if they can't
                        already see it?
                        <br />
                      </p>
                      <DropdownComponent />
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    ...
                    <li>
                      <p className='secrtySec'>
                        Review tags that people add to your posts before the tags appear on Shareup?
                        <br />
                      </p>
                      <DropdownOnComponent />
                    </li>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      <p className='secrtySec'>
                        Followers see your posts in NewsFeed. Friends follow your posts by default, but you can also
                        allow people who are not your friends to follow your public posts. Use this setting to chose who
                        can follow you{' '}
                      </p>
                      <DropdownComponent />
                    </li>
              ...
              <div className='right-settings-bio-top'>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      <p className='secrtySec'>
                        Who can like or comment on your public profile pictures and other profile info? Friends
                        <br />
                      </p>
                      <DropdownComponent />
                    </li>
      ...
      <div className='central-settings'>
        <div className='left-settings settngPadding'>
          <div>
            <h1>Settings</h1>
            {show === 'general' ? (
              <div className='settings-list active' onClick={() => setShow('general')}>
            ...
            {show === 'security' ? (
              <div className='settings-list active' onClick={() => setShow('security')}>
                <img src='assets/images/scrtyStng.svg' />
                <p>Security and Privacy</p>
              </div>
            ) : (
              <div className='settings-list' onClick={() => setShow('security')}>
                <img src='assets/images/scrtyStng.svg' />
                <p>Security and Privacy</p>
              </div>
            )}
            {show === 'location' ? (
              ...
              <div className='settings-list brdrbtmEdtprf' onClick={() => setShow('location')}>
                <img src='assets/images/locstng.svg' />
                <p>Location</p>
              </div>
            )}
            ...
            {show === 'language' ? (
              <div className='settings-list active' onClick={() => setShow('language')}>
                <img src='assets/images/langstng.svg' />
                <p>Language and region</p>
              </div>
            ) : (
              <div className='settings-list' onClick={() => setShow('language')}>
                <img src='assets/images/langstng.svg' />
                <p>Language and region</p>
              </div>
            )}
            ...
            {show === 'profile' ? (
              <div className='settings-list active' onClick={() => setShow('profile')}>
                <img src='assets/images/userstng.svg' />
                <p>Profile and Tags</p>
              </div>
            ) : (
              <div className='settings-list' onClick={() => setShow('profile')}>
                <img src='assets/images/userstng.svg' />
                <p>Profile and Tags</p>
              </div>
            )}
            ...
            {show === 'publicpost' ? (
              <div className='settings-list active' onClick={() => setShow('publicpost')}>
                <img style={{ height: '22px' }} src='assets/images/pblcstng.svg' />
                <p>Public Posts</p>
              </div>
            ) : (
              <div className='settings-list' onClick={() => setShow('publicpost')}>
                <img style={{ height: '22px' }} src='assets/images/pblcstng.svg' />
                <p>Public Posts</p>
              </div>
            )}
