      ...
      return (
        <fieldset>
          <div className='form-card'>
            ...
            {groupNameError && <p style={{ fontSize: 15, color: 'red' }}>{groupNameError}</p>}
            <input
              type='group_name'
              name='group_name'
            ...
            />
            {groupDescError && <p style={{ fontSize: 15, color: 'red' }}>{groupDescError}</p>}
        ...
        <fieldset>
          <div className='form-card'>
            ...
            <div className=''>
              ...
              />
              <label htmlFor='other'>All Group Members</label>
              <br></br>
              <input
                type='radio'
                name='group-invite-status'
                ...
                onChange={handleInviteSetting}
              />
              <label htmlFor='other'>Group admins and mods only</label>
              <br></br>
              <input
                type='radio'
                name='group-invite-status'
                ...
                onChange={handleInviteSetting}
              />
              <label htmlFor='other'>Group admins only</label>
              <br></br>
            </div>
          </div>
          <input
