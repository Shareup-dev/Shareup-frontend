          ...
          <div className='right-settings-content'>
            <div className='right-settings-bio-top'>
              <p className='clrHead'>
                ...
                Martina Wolna <img src='assets/images/img/phone.png' /> <img src='assets/images/img/video.png' />{' '}
              </p>
            </div>
                ...
                <div className='right-settings-details'>
                  <ul>
                    <li className='firstElement'>
                      ...
                      <p className='secrtyEdt'>Friends</p>
                    </li>
                    <li className='firstElement'>
                    ...
                    <li className='firstElement'>
                      ...
                      <p className='secrtyEdt'>On</p>
                    </li>
                    <li>
                      <p className='secrtySec'>Who can see what others post on your profile?</p>
                      <p className='secrtyEdt'>Off</p>
                    </li>
                  </ul>
                </div>
              </div>
