            ...
            <div className='widget-prof'>
              <ul>
                ...
                <li>
                  <div className='row'>
                    <input type='checkbox' />
                    <p>Allow my contacts to download photos I share to my ShareTime</p>
                  </div>
                </li>
              </ul>
            </div>
                      ...
                      !friendsList.some((el) => el.id === userM.id) ? (
                        friendRequestRecieved.some((el) => el.id === userM.id) ? (
                          <>
                            ...
                            <p>
                              <a
                                style={{ display: 'block', float: 'right', color: 'gray' }}
                                href='#'
                ...
                <div className='row'>
                  <div className='col-lg-3'>
                    {showProfilePicture ? (
                      ...
                      <img className='border-gradient' src={fileStorage.baseUrl + userProfile.profilePicturePath}></img>
                    ) : (
                ...
                <div className='timeline-info'>
                  <div className='row'>
                    ...
                    <div className='col brdrmid'>
                      <a
                        className={show === 'photos' ? 'active button' : 'button'}
                        title=''
                        data-ripple=''
