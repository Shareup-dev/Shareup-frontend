      ...
      <div>
        ...
        <div className="row merged">
          ...
          <section style={{zIndex:'0'}}>
            <div className="feature-photo" style={{boxShadow:'none', marginTop:'52px'}}>
              <div className="container pdng1" style={{padding:'11px 5% 15px 5%' }}>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6" style={{maxWidth:'54%', flex: '0 0 54%'}}>

                    <h5>{`${userProfile.firstName} ${userProfile.lastName}`}</h5>
                    {/* <span>{`${userProfile.email}`}</span> */}
                    <div className="profsts">
                      <ul>
                        <li><span style={{ textAlign: 'center' }}>87</span><span>Posts</span></li>
                        <li><span style={{ textAlign: 'center' }}>234</span><span>Followers</span></li>
                        <li><span style={{ textAlign: 'center' }}>2.3K</span><span>Following</span></li>
                        <li><span style={{ textAlign: 'center' }}>119</span><span>Friends</span></li>
                      </ul>
                      <span style={{ paddingTop: '30px' }}>Feeling happy to share and find my soul</span>
                    </div>
                    
                   
                    

                      <div style={{ float: 'right', marginTop: '10%', marginRight: '10px' }}>
                      <a href="/editprofile" style={{position: 'absolute',top:'280px',right: '-222px', color: '#000000', fontWeight: 'bold', background: '#D6D6D6' }} className="button">Edit Profile</a>
                      </div>
                  ...
                  {/* <div style={{ float: 'right', marginTop: '10%', marginRight: '10px' }}>
                      <a href="/editprofile" style={{ color: '#000000', fontWeight: 'bold', background: '#D6D6D6' }} className="button">Edit Profile</a>
                      </div> */}



                      <div className="feature-photo" style={{boxShadow:'none', height: '250px', borderRadius: '10px' }}>
                        <div className="container pdng1" style={{ padding: '12px' }}>
                          <span className="profileTitles" style={{color:'black', paddingLeft:'0px'}} >
                            Bio
                          </span>
                          ...
                          <div className="right-settings-bio " style={{ borderTop: '0px solid', marginTop: '25px', paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr" style={{color:'black'}}>Birth Town</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr" style={{color:'black'}}>Nick Name </p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">shareup</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr" style={{color:'black'}}>Astro </p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">Scorpio</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr" style={{color:'black'}}>Age</p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">private</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr" style={{color:'black'}}>Shareup Account </p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">shareup.1@gmail.com</p>
...
{/* 
                          <a href="/Security " style={{ fontSize: '12px', paddingTop: '5px', width: '100%', textAlign: 'center', cursor: 'pointer', float: "right", textDecorationLine: 'underline', color: "#258eae" }}
                          >
                ...
                <div><div className="stories" style={{paddingLeft:' 241px', marginTop:'-30px'}}>
      ...
      <div className="container">
        <section>
          <div className="gap gray-bg" style={{paddingTop:'0px'}}>
              ...
              <div className="row">
                <div className="col-lg-12">
                  ...
                  <div className="row" id="page-contents">
                    ...
                    <div className="col-lg-3" style={{ maxWidth: '21%', paddingLeft: '45px' }}>
                     
                    <div className="feature-photo" style={{ height: '387px', borderRadius: '10px' }}>
                        <div className="container pdng1" style={{ padding: '12px' }}>
                          ...
                          <div className="right-settings-bio " style={{ borderTop: '0px solid', marginTop: '25px', paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr">Status</p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">Online</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr">Profile Privacy</p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">private</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr">Location</p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">Off</p>
                          ...
                          <div className="right-settings-bio " style={{ paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr">Notification alert</p>
                              <div className="profile-settings-details" >
                                <ul>
                                  <li>
                                    <p className="secrtySec">On</p>
                          ...
                          <div className="right-settings-bio " style={{ marginBottom: '20px', paddingRight: '10px' }}>
                            <div className="right-settings-bio-top">
                              <p className="profileclr">Location</p>
                              <div className="profile-settings-details" >
                                <ul>
                      ...
                      <div className="feature-photo" style={{ height: '387px', borderRadius: '10px' }}>
                        <div className="container pdng1" style={{ padding: '5px' }}>
                          <span className="profileTitles" style={{}}>
                            Friends
                          </span>
                    ...
                    <div className='col-lg-6' style={{ padding: '0px' }}>
                      <div className="row merged">
                        ...
                        <section>
                          <div className="feature-photo" style={{ borderRadius: '10px' , marginTop:'6px'}}>
                         


                          </div>

                          <div className="container pdng1" style={{ padding: '0px' }}>
                    ...
                    <div className="col-lg-3" style={{}}>
                      ...
                      <div className="feature-photo" style={{ height: '240px', borderRadius: '10px' }}>
                        <div className="container pdng1" style={{ padding: '5px' }}>
