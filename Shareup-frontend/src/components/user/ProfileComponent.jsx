          ...
          <div className='right-edit-profile-bio'>
            ...
            <div className='right-edit-profile-details'>
              <ul>
                ...
                <li>
                  <p>
                    <i className='las la-home' aria-hidden='true' /> <span className='bio'>{currentTown}</span>
                  </p>
                </li>
                ...
                <li>
                  <p>
                    <i class='lab la-gratipay'></i> <span className='bio'>{relationshipStatus}</span>
                  </p>
                </li>
              </ul>
            </div>
              ...
              <div className='row'>
                <div className='col-lg-3'>
                  ...
                  <form className='edit-phto'>
                    ...
                    <a href='#!' id='submit' name='submit' onClick={uploadProfilePicture}>
                      Upload
                    </a>
                  </form>
                </div>
                ...
                <div className='col-lg-3'>
                  <div style={{ float: 'right', marginTop: '10%', marginRight: '10px' }}>
                    <a
                      href='/editprofile'
                      style={{ color: '#000000', fontWeight: 'bold', background: '#D6D6D6' }}
                      className='button'
                    >
                      Edit Profile
                    </a>
