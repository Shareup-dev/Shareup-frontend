        ...
        <div className="loadMore">
          <div className="brands">
            <div className="row">
              ...
              <div className="arrow">
                <a style={{ color: '#000000', padding: '5px', fontSize: '18px' }} href="#">
          ...
          <div className="central-meta hanggift">
            ...
            <div className="containerHang">
              ...
              <div className="row rowalin">
                <h1 style={{ textAlign: 'center', padding: '10px', fontSize: '18px', fontWeight: 'lighter' }}>
                  To Swap You will have to Provide clear image of the object you want to swap
                </h1>
