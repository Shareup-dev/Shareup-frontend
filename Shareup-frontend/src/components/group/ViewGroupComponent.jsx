...
function ViewGroupComponent({ post }) {
  ...
  const showOrNot = () => {
    ...
    if (group.members.some((member) => member.id === user.id)) {
      ...
      return <h3 style={{ textAlign: 'center' }}>Join Group To See Content</h3>;
    }
  };
  const imageshowPost = () => {
    return (
                    ...
                    <aside className='sidebar static'>
                      <div className='widget'>
                        <div className='row'>
                          ...
                          <p className='widget-title'>User</p>
                        </div>
                        <div className='user'>
                      ...
                      <div className='widget'>
                        <div className='row'>
                          <img src='../assets/images/unnamed.png' />
                          <p className='widget-title'>Group</p>
                        </div>
                        <div className='row'>
                          <div>
                            <img
                              src={`../../assets/images/21964583.png`}
                              style={{ width: '45px', height: '45px', float: 'left', margin: '5px' }}
                            ></img>
                          </div>
                          <div>
                            <a style={{ marginBottom: '0' }} href={`/profile`}>
                              <p style={{ fontWeight: 'bold', marginBottom: '0' }}>{`${group.name}`}</p>
                            </a>
                            ...
                            <div>
                              {checkIfInGroup(group.members) ? (
                                <a
                                  style={{ marginBottom: '0', fontSize: '14px', color: '#057b96' }}
                                  href
                                  type='button'
                  ...
                  <div className='col-lg-3'>
                    <aside className='sidebar static'>
                      <div className='widget friend-list stick-widget'>
                        <div className='row'>
                          <img src='../assets/images/1865023.png' />
                          <p className='widget-title'>Ads</p>
                        </div>
                        <div className='ads'>
                          <a
                            href='https://technology-signals.com/wp-content/uploads/2019/05/images.martechadvisor.comvoice_technology_5cecf0b8-3f280e5abac0da913f8aa0868cf970c6a429a128.jpg'
                      ...
                      <div className='widget'>
                        <div className='row'>
                          <img src='../assets/images/b76706b9814f347e841ff15b89a5d170-instagram-discover-people-icon-by-vexels.png' />
                          <p className='widget-title'>Groups Members</p>
                        </div>
