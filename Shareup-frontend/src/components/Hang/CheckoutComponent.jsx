        ...
        <div className='central-meta  pdngPay'>
          <div className='new-postbox '>
            <Form>
              ...
              <div className='billInpt'>
                <span style={{ padding: '0 30% 0 0' }}>Total</span>
                <span style={{ padding: '0 20% 0 0' }}>:</span> {amount}QR
              </div>
              ...
              <div className='prdct'>
                <div className='row'>
                  ...
                  <div style={{ display: 'inline', width: '33%', float: 'right', padding: '0 5px' }}>
                    ...
                    >
                      <a
                        style={{ color: '#fff', padding: '5px', fontSize: '12px' }}
                        href='#'
                        onClick={() => handleCountAndTotal('-')}
                      >
                        -
                      </a>
              ...
              <h1 style={{ fontWeight: '600' }}>Payment Method</h1>
              {data}
              <div style={{ padding: '20px' }}>
                <p style={{ fontSize: '14px' }}>Name on card</p>
                <div className='row'>
                  <input className='pay1' placeholder='Enter name on card' type='text' />
                </div>
                <p style={{ fontSize: '14px' }}>Card Number</p>
                <div className='row'>
                  <input className='pay1 see' id='search' name='search' placeholder='Enter card number' type='text' />
                </div>
                <div className='row'>
                ...
                <div className='row mrgintp'>
                  <div className='col'>
                    <a href='#' style={{ background: 'rgb(234, 234, 234)', color: '#6b6b6b' }} className='butnpay'>
                      Cancel
                    </a>
                  </div>
                  <div className='col'>
                    <a
                      ...
                      style={{ background: 'rgb(3, 51, 71)', color: '#fff' }}
                      className='butnpay'
                    >
                      Pay
                    </a>
