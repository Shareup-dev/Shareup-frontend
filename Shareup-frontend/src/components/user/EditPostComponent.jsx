  ...
  return (
    <div className='friend-info'>
      ...
      <div className='post-meta'>
        {post.postImagePath ? (
          <img style={{ maxWidth: '100%', height: 'auto' }} src={fileStorage.baseUrl + post.imagePath} />
        ) : null}
          ...
          <ul>
            <li>
              <span className='views' data-toggle='tooltip' title='views'>
                {`${post.views}`} <i className='fa fa-eye' />
              </span>
            </li>
            <li>
            ...
            <li>
              <span className='like' data-toggle='tooltip' title='like'>
                {`${post.reactions.length}`} <i className='fa fa-trophy' aria-hidden='true' />
              </span>
            </li>
            <li>
            ...
            <li>
              <span onClick={handleUpdatePost}>Save</span>
            </li>
          </ul>
        </div>
      </div>
