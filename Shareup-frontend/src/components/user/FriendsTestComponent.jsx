                ...
                <li key={userM.id}>
                  <div className='cardprofile'>
                    <figure className='snip1336'>
                      <img
                        src={
                          userM.coverPicturePath
                            ? fileStorage.baseUrl + userM.coverPicturePath
                      ...
                      <figcaption>
                        ...
                        <h2>
                          ...
                          <span>{userM.job ? userM.job : `No Job`}</span>{' '}
                        ...
                        <p>
                          If you want to stay dad you've got to polish your image. I think the image we need to create
                          for you is "repentant but learning".
                        </p>
                            ...
                            friendRequestRecieved.some((el) => el.id === userM.id) ? (
                              <>
                                <a
                                  ...
                                  className='follow'
                                  data-ripple
                                  onClick={() => acceptFriendRequest(user.id, userM.id)}
                                >
                                ...
                                <a
                                  ...
                                  className='info'
                                  data-ripple
                                  onClick={() => declineFriendRequest(user.id, userM.id)}
                                >
                              ...
                              <p>
                                <a
                                  ...
                                  className='info'
                                  data-ripple
                                  onClick={() => unsendFriendRequest(user.id, userM.id)}
                                >
                              ...
                              <p>
                                <a
                                  ...
                                  className='follow'
                                  data-ripple
                                  onClick={() => sendFriendRequest(user.id, userM.id)}
                                >
                                  Send Friend Request
                                </a>
                              </p>
    ...
    return (
      <div className='tab-content'>
        <input
          ...
          name='s'
          onChange={handleSearchedFollowing}
        />
              ...
              <li key={userM.id}>
                <div className='nearly-pepls'>
                  ...
                  <div className='pepl-info'>
                    ...
                    <p>
                      <a href={`/profile/${userM.email}`} title={`${userM.email}`}>{`${userM.email}`}</a>
                    </p>
                    <span>Engr</span>
                    <a
                      href='#'
          ...
          <ul className='nearby-contct'>
            {followers.map((userM) => (
              <li key={userM.id}>
                <div className='nearly-pepls'>
                  <figure>
                    <a href={`/profile/${userM.email}`} title='#'>
                      <img src='https://wallpaperaccess.com/full/2213424.jpg' alt='' />
                    </a>
                  </figure>
                  <div className='pepl-info'>
  ...
  const FriendRequestRecievedComponentFunction = () => {
    return (
      <div className='tab-content'>
        ...
        <div className='tab-pane active fade show ' id='following'>
          <ul className='nearby-contct'>
            {friendRequestRecieved.map((userM) => (
              <li key={userM.id}>
          ...
          <div className='frnds'>
            <ul className='nav nav-tabs'>
              <li className='nav-item'>
                <a className='' href='#!' onClick={() => setShowComp('members')} data-toggle='tab'>
                  Members
                </a>{' '}
                <span>{`${allUser.length}`}</span>
              </li>
              <li className='nav-item'>
                <a className='' href='#!' onClick={() => setShowComp('following')} data-toggle='tab'>
                  Following
                </a>{' '}
                <span>{`${following.length}`}</span>
              </li>
              <li className='nav-item'>
                <a className='' href='#!' onClick={() => setShowComp('followers')} data-toggle='tab'>
                  Followers
                </a>{' '}
                <span>{`${followers.length}`}</span>
              </li>
              <li className='nav-item'>
                <a className='' href='#!' onClick={() => setShowComp('friendRequestSent')} data-toggle='tab'>
                  Request Sent
                </a>
                <span>{`${friendRequestSent.length}`}</span>
              </li>
              <li className='nav-item'>
                <a className='' href='#!' onClick={() => setShowComp('friendRequestRecieved')} data-toggle='tab'>
                  Request Recieved
                </a>
                <span>{`${friendRequestRecieved.length}`}</span>
              </li>
            </ul>
            <br></br>
            {handleShowComp()}
