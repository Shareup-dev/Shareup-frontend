...
export default function EditProfileComponent() {
  ...
  const handleDescribeYourself = (event) => {
          ...
          <div className='right-edit-profile-content'>
            <div className='right-edit-profile-image'>
              <label className='fileContainer '>
                <div className='add-prof mrgnFileCntnrEdtProf'>+</div>
                <input
                  id='file-input'
                  type='file'
                  name='profile_image'
            ...
            <div className='right-edit-profile-bio'>
              <div className='right-edit-profile-bio-top'>
                <p>Bio</p>
                <p>
                  <a href='#' className='text-color' onClick={updateProfile}>
                    Save
                  </a>
                </p>
              </div>
            ...
            <div className='right-edit-more-details'>
              <p>
                <span className='text-color'>Professional information settings</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='right-edit-profile'>
          <div className='right-edit-profile-content'>
            ...
            <div className='right-edit-personal-information'>
              <p>
                Provide your Personal information, even if the account is used for a bussiness , a pet or something
                else. This wont be part of your public profile
              </p>
            ...
            <div className='right-edit-profile-details padding'>
              <ul>
                <li>
                  ...
                  <div className='right-edit-details-input'>
                    <input type='text' value={currentTown} onChange={handleCurrentTown} />
                  </div>
                </li>
                <li>
                  <div style={{ flex: 1, textAlign: 'left' }}>
                  ...
                  <div className='right-edit-details-input'>
                    <input type='text' value={homeTown} onChange={handleHomeTown} />
                  </div>
                </li>
                <li>
                  <div style={{ flex: 1, textAlign: 'left' }}>
                  ...
                  <div className='right-edit-details-input'>
                    <input type='text' value={relationshipStatus} onChange={handleRelationshipStatus} />
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className='right-edit-profile-content'>
            ...
            <div className='right-edit-profile-details padding'>
              <ul>
                ...
                <li>
                  <div style={{ flex: 1, textAlign: 'left', lineHeight: '2' }}>
                    <p>Phone Number</p>
                  </div>
                  <div className='right-edit-details-input'>
                    <input type='text' />
      ...
      <div className='central-edit-profile'>
        <div className='left-edit-profile'>
          <div>
            <h1>Edit Profile</h1>
            {show === 'overview' ? (
              <div className='edit-profile-list active' onClick={() => setShow('overview')}>
                <p>Overview</p>
              </div>
            ) : (
              <div className='edit-profile-list' onClick={() => setShow('overview')}>
                <p>Overview</p>
              </div>
            )}
            {show === 'personal information' ? (
              <div className='edit-profile-list active' onClick={() => setShow('personal information')}>
                <p>Personal Information</p>
              </div>
            ) : (
              <div className='edit-profile-list' onClick={() => setShow('personal information')}>
                <p>Personal Information</p>
              </div>
            )}
            {show === 'your details' ? (
              <div className='edit-profile-list active' onClick={() => setShow('your details')}>
                <p>Your Details</p>
              </div>
            ) : (
              <div className='edit-profile-list' onClick={() => setShow('your details')}>
                <p>Your Details</p>
              </div>
            )}
            {show === 'basic contact info' ? (
              <div className='edit-profile-list active' onClick={() => setShow('basic contact info')}>
                <p>Basic Contact Info</p>
              </div>
            ) : (
              <div className='edit-profile-list' onClick={() => setShow('basic contact info')}>
                <p>Basic Contact Info</p>
              </div>
            )}
          </div>
